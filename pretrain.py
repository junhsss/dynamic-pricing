...
def parser():
    ...
    parser.add_argument("--vae_hidden_dim", default=500, type=int)
    parser.add_argument("--vae_depth", default=2, type=int)
    parser.add_argument("--vae_factor", default=1, type=float)
...
if __name__ == "__main__":
    ...
    if args.mode == "bcq":
        agent = BCQ(
            ...
            vae_hidden_dim=[int(float(dim)*(args.vae_factor**i)) for i,dim in enumerate([args.vae_hidden_dim] * args.vae_depth)],
